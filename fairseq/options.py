...
def add_generation_args(parser):
    ...
    # Multi-branch Transformer added options.
    group.add_argument('--scorer', default='bleu', choices=['bleu', 'summ', 'codegen'],
                       help='Specify the scorer')
    group.add_argument('--codegen-pov-replace-unk', action='store_true', default=True,
                       help='Replace unknown token to "UNK" in codegen PoV computation')
    group.add_argument('--no-codegen-pov-replace-unk', dest='codegen_pov_replace_unk', action='store_false', default=True,
                       help='Disable replace unknown token to "UNK" in codegen PoV computation')
    group.add_argument('--dump-hyp', default=None, metavar='FILE',
                       help='Dump hypo strings to file')
    # fmt: on
    return group
